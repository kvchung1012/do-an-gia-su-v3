...
CREATE TABLE `booked_session` (
  `booked_session_id` varchar(50) NOT NULL,
  `student_id` varchar(50) DEFAULT NULL,
  `tutor_id` varchar(50) DEFAULT NULL,
  `price` varchar(50) DEFAULT NULL,
  `checkout_session_id` varchar(50) DEFAULT NULL,
...
CREATE TABLE `course` (
  ...
  `price` varchar(50) DEFAULT NULL,
  `number_of_phase_required` varchar(50) DEFAULT NULL,
...
-- Dump completed on 2023-12-10 23:27:54
